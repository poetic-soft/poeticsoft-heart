...
var API_BASE = 'poeticsoft/heart';
var IS_DEV = true; // Cambiar a false en producción

var apiClient = {
  /**
   * Helper para logs de desarrollo
   */
  _log: function _log(endpoint, response) {
    if (!IS_DEV) return;
    var data = response.data;
    var meta = data === null || data === void 0 ? void 0 : data.meta;
    console.groupCollapsed("%c API: ".concat(endpoint), 'color: #007cba; font-weight: bold;');
    if (meta) {
      console.log("Fecha API: ".concat(meta.fecha));
      console.log("Timestamp: ".concat(meta.timestampms));
    }
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            ...
            path = "".concat(API_BASE, "/").concat(endpoint.replace(/^\//, ''));
            _context.p = 1;
            _context.n = 2;
            return apiFetch({
              path: path,
          ...
          case 3:
            return _context.a(2, {
              success: false,
              message: ((_response$data = response.data) === null || _response$data === void 0 ? void 0 : _response$data.error) || 'La operación no pudo completarse.',
              status: ((_response$data2 = response.data) === null || _response$data2 === void 0 ? void 0 : _response$data2.status) || 400
            });
          case 4:
            _context.p = 4;
            _t = _context.v;
            // Error de infraestructura (404, 500, rest_no_route, etc)
            console.error("Error cr\xEDtico en ".concat(endpoint, ":"), _t);
            return _context.a(2, {
              success: false,
              message: _t.message || 'Error de comunicación con el servidor.',
              code: _t.code || 'unknown_error'
            });
        }
      }, _callee, null, [[1, 4]]);
    }))();
...
/***/ "./src/common/js/components/dashboard/main.js"
/*!****************************************************!*\
  !*** ./src/common/js/components/dashboard/main.js ***!
  \****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/common/js/components/dashboard/options/field.js"
/*!*************************************************************!*\
  !*** ./src/common/js/components/dashboard/options/field.js ***!
  \*************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/common/js/components/dashboard/options/main.js"
/*!************************************************************!*\
  !*** ./src/common/js/components/dashboard/options/main.js ***!
  \************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/common/js/store/actions/dashboards-options.js"
/*!***********************************************************!*\
  !*** ./src/common/js/store/actions/dashboards-options.js ***!
  \***********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/common/js/store/actions/main.js"
/*!*********************************************!*\
  !*** ./src/common/js/store/actions/main.js ***!
  \*********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _portals__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./portals */ "./src/common/js/store/actions/portals.js");
/* harmony import */ var _dashboards_options__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dashboards-options */ "./src/common/js/store/actions/dashboards-options.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_objectSpread(_objectSpread({}, _portals__WEBPACK_IMPORTED_MODULE_0__["default"]), _dashboards_options__WEBPACK_IMPORTED_MODULE_1__["default"]));

/***/ },

/***/ "./src/common/js/store/actions/portals.js"
/*!************************************************!*\
  !*** ./src/common/js/store/actions/portals.js ***!
  \************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _actions_main__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./actions/main */ "./src/common/js/store/actions/main.js");
...
/***/ "./src/common/js/store/reducer/main.js"
/*!*********************************************!*\
  !*** ./src/common/js/store/reducer/main.js ***!
  \*********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _state__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../state */ "./src/common/js/store/state.js");
/* harmony import */ var _portals__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./portals */ "./src/common/js/store/reducer/portals.js");
/* harmony import */ var _dashboard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dashboard */ "./src/common/js/store/reducer/dashboard.js");




/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _state__WEBPACK_IMPORTED_MODULE_1__["default"];
  var action = arguments.length > 1 ? arguments[1] : undefined;
  return (0,immer__WEBPACK_IMPORTED_MODULE_0__.produce)(state, function (draft) {
    (0,_portals__WEBPACK_IMPORTED_MODULE_2__["default"])(draft, action);
    (0,_dashboard__WEBPACK_IMPORTED_MODULE_3__["default"])(draft, action);
  });
});

/***/ },

/***/ "./src/common/js/store/reducer/portals.js"
/*!************************************************!*\
  !*** ./src/common/js/store/reducer/portals.js ***!
  \************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/common/js/store/resolvers/dashboards-options.js"
/*!*************************************************************!*\
  !*** ./src/common/js/store/resolvers/dashboards-options.js ***!
  \*************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/common/js/store/resolvers/main.js"
/*!***********************************************!*\
  !*** ./src/common/js/store/resolvers/main.js ***!
  \***********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _portals__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./portals */ "./src/common/js/store/resolvers/portals.js");
/* harmony import */ var _dashboards_options__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dashboards-options */ "./src/common/js/store/resolvers/dashboards-options.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
...
/***/ "./src/common/js/store/resolvers/portals.js"
/*!**************************************************!*\
  !*** ./src/common/js/store/resolvers/portals.js ***!
  \**************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/common/js/store/selectors/dashboards-options.js"
/*!*************************************************************!*\
  !*** ./src/common/js/store/selectors/dashboards-options.js ***!
  \*************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/common/js/store/selectors/main.js"
/*!***********************************************!*\
  !*** ./src/common/js/store/selectors/main.js ***!
  \***********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _portals__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./portals */ "./src/common/js/store/selectors/portals.js");
/* harmony import */ var _dashboards_options__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dashboards-options */ "./src/common/js/store/selectors/dashboards-options.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
...
/***/ "./src/common/js/store/selectors/portals.js"
/*!**************************************************!*\
  !*** ./src/common/js/store/selectors/portals.js ***!
  \**************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
